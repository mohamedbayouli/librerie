...
{
    #[Route('/user/calendar/reserve', name: 'app_calendar_reserve', methods: ['POST'])]
...
#[Route('/user/calendar/{id}', name: 'app_calendar')]
   ...
   #[Route('/user/calendar/load/{id}', name: 'app_calendar_load')]
